        ...
        <div className="min-h-screen bg-background-light dark:bg-background-dark">
                    ...
                    <div className="flex flex-col lg:flex-row items-center gap-16 lg:gap-24">
                        <div className="w-full lg:w-1/2">
                            <div className="relative">
                                ...
                                <img
                                    src="/images/sala_pequena.jpg?v=3"
            ...
            <section className="py-24 bg-background-dark relative overflow-hidden">
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
                    <h2 className="font-display text-3xl md:text-5xl font-bold text-white mb-8">Espacio 100% Versátil</h2>
                    <p className="font-body text-gray-400 text-lg md:text-xl max-w-4xl mx-auto leading-relaxed lg:px-20">
                        Desde una fiesta con DJ hasta una merienda temática. Adaptamos la Sala Frecuenzy para que tu cumpleaños sea exactamente como lo imaginaste.
                    </p>
                </div>
            </section>
            ...
            <div id="contacto" className="py-20 lg:py-32 bg-surface-light dark:bg-surface-dark border-t border-gray-100 dark:border-gray-800">
                <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                    <ContactForm segment="cumpleanos" />
                </div>
            </div>
