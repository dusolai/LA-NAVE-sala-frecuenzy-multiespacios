    ...
    <div className="min-h-screen bg-background-light dark:bg-background-dark">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 lg:py-32">
          <div className="max-w-3xl animate-in fade-in duration-1000">
            ...
            <h1 className="font-display text-5xl lg:text-7xl font-bold text-white mb-8 leading-tight">
              Tu evento con<br /><span className="text-primary italic">estilo propio</span>
            </h1>
            <p className="font-body text-gray-300 text-lg lg:text-xl mb-12 leading-relaxed max-w-2xl">
              Desde fiestas exclusivas hasta celebraciones familiares íntimas. Ofrecemos un espacio industrial singular que se adapta totalmente a tu visión y necesidades.
            </p>
            <a
              href="#contacto"
      ...
      <section className="py-24 bg-background-dark relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
          <h2 className="font-display text-3xl md:text-5xl font-bold text-white mb-8">Personalización total</h2>
          <p className="font-body text-gray-400 text-lg md:text-xl max-w-4xl mx-auto leading-relaxed lg:px-20">
            Nuestra sala multiespacios es tu lienzo en blanco. Configura el mobiliario, la iluminación y la decoración para crear la atmósfera perfecta para tu celebración privada.
          </p>
        </div>
      </section>
        ...
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-y-4 gap-x-12 text-left">
            {[
              ...
              'Mobiliario lounge básico',
              'Parking privado vigilado',
              'Zona de camerinos/backstage',
              'Personal de coordinación técnica',
            ].map((item, index) => (
