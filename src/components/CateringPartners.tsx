      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <div className="glass-effect p-8 md:p-12 rounded-3xl border border-gray-100 dark:border-gray-800 shadow-xl relative overflow-hidden">
          ...
          <p className="font-body text-gray-600 dark:text-gray-300 text-lg leading-relaxed mb-8 relative z-10">
            Opciones gastronómicas de primer nivel. Tú elige el catering que más te guste, o nosotros te recomendamos nuestros convenios
            para que te salga más rentable. La variedad y la calidad están garantizadas.
          ...
          <div className="pt-8 border-t border-gray-100 dark:border-gray-800">
            <p className="text-[10px] uppercase tracking-[0.2em] font-bold text-gray-400 mb-4">Nuestro compromiso</p>
